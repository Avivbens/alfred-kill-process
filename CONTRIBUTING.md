# Contributing to `alfred-kill-process`

Thank you for your interest in contributing to `alfred-kill-process` :tada: !
...
(cd esbuild && open alfred-kill-process.alfredworkflow)
```
